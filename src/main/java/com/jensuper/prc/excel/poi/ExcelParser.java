...
public class ExcelParser {
     ...
     * @throws ParseException
     */
    public synchronized ExcelParser parseSheet(InputStream stream, int sheetId)
            throws InvalidFormatException, IOException, ParseException {
        // 每次转换前都清空数据
        datas.clear();
        // 打开表格文件输入流
        ...
        try {
            ...
            for (int i = 1; i < 100; i++) {
                // 转换指定单元表
                InputStream shellStream = reader.getSheet("rId" + i);
